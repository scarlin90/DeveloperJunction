...
@NgModule({
    declarations: [AdminComponent, CompaniesManagementComponent, ManagementCardComponent, AddCompanyComponent, CompanyListingComponent, JobsManagementComponent, AddJobComponent, JobListingComponent],
